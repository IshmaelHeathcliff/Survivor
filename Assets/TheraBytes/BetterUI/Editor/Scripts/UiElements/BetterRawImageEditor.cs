...
namespace TheraBytes.BetterUi.Editor
{
    ...
    public class BetterRawImageEditor : GraphicEditor
    {
        ...
        private SerializedProperty raycastPaddingFallback;
        private SerializedProperty raycastPaddingCollection;
        ...
        protected override void OnEnable()
        {
            ...
            this.raycastPaddingFallback = base.serializedObject.FindProperty("raycastPaddingFallback");
            this.raycastPaddingCollection = base.serializedObject.FindProperty("raycastPaddingSizers");
        ...
        private void DrawTextureSettings(string configName, SerializedProperty property)
        {
            ...
            SerializedProperty flippingModeProp = property.FindPropertyRelative("FlippingMode");
            ...
            EditorGUILayout.PropertyField(flippingModeProp);
        ...
        private void DrawRaycastGUI()
        {
            ...
            if (raycastPaddingFallback == null)
                return; // Unity version too old

            ScreenConfigConnectionHelper.DrawSizerGui("Raycast Padding", raycastPaddingCollection, ref raycastPaddingFallback);
        }
